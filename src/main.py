...
def main():
    ...
    parser.add_argument("--threshold", type=float, help="Override AI score threshold (0.0-10.0)")
    ...
    try:
        ...
        asyncio.run(orchestrator.run(force_hours=args.hours, force_threshold=args.threshold))
